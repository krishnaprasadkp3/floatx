    ...
    this.buildLocation = (opts) => {
      const build = (dest = {}) => {
        ...
        if (destRoute && !opts.leaveParams) try {
          if (((_b = this.getMatchedRoutes(nextPathname).foundRoute) == null ? void 0 : _b.id) !== destRoute.id) console.warn(`Generated path "${nextPathname}" for route "${destRoute.id}" did not match the same route after params.stringify.`);
        } catch {
        }
        let nextSearch = fromSearch;
        if (opts._includeValidateSearch && ((_c = this.options.search) == null ? void 0 : _c.strict)) {
...
function getStylesheetHref(asset) {
  ...
  const rel = (_a = asset.attrs) == null ? void 0 : _a.rel;
  const href = (_b = asset.attrs) == null ? void 0 : _b.href;
...
function isInlinableStylesheet(manifest, asset) {
  ...
  return !!href && ((_a = manifest == null ? void 0 : manifest.inlineCss) == null ? void 0 : _a.styles[href]) !== void 0;
}
...
function buildTagsFromMatches(router, nonce, matches, assetCrossOrigin) {
  ...
  }).filter(Boolean).flat(1).flatMap((asset) => {
    var _a2;
    if (asset.tag === "link") {
